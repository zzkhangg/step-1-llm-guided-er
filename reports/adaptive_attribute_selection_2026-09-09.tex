...
This week completed the DBLP--Scholar evaluation, validated the saved results,
and documented operational deviations. The focus is the comparison between
pair-adaptive attribute selection and matching with all attributes.
...
\section{Hyperparameters and Evaluation Protocol}
...
\subsection{Descriptive Result Statistics}
Table~\ref{tab:stats} summarises only the two completed repetitions per arm
on 7 September. SD is the sample standard deviation across run-level metrics
($n=2$, denominator $n-1$), computed before rounding. It is not a standard error
or a confidence interval. With only two repetitions and a reused selector,
these statistics are descriptive, not evidence of general statistical significance.
The single 4 September draw per arm has no estimable between-run SD.
...
\begin{tabular}{llrrl}
\toprule
Metric & Arm & Mean & SD & Min--max \\
\midrule
Precision & Adaptive & 0.8722 & 0.0045 & 0.8690--0.8754 \\
 & Full & 0.6964 & 0.0184 & 0.6834--0.7094 \\
Candidate recall & Adaptive & 0.9537 & 0.0031 & 0.9516--0.9559 \\
 & Full & 0.9665 & 0.0089 & 0.9602--0.9728 \\
Candidate F1 & Adaptive & 0.9111 & 0.0011 & 0.9104--0.9119 \\
 & Full & 0.8095 & 0.0156 & 0.7985--0.8205 \\
End-to-end recall & Adaptive & 0.4531 & 0.0015 & 0.4520--0.4541 \\
 & Full & 0.4591 & 0.0042 & 0.4561--0.4621 \\
End-to-end F1 & Adaptive & 0.5963 & 0.0002 & 0.5962--0.5965 \\
 & Full & 0.5534 & 0.0089 & 0.5471--0.5597 \\
Pipeline tokens & Adaptive & 3,031,542.5 & 77.1 & 3,031,488--3,031,597 \\
 & Full & 3,718,149 & 240.4 & 3,717,979--3,718,319 \\
\bottomrule
\end{tabular}
\caption{Run-level descriptive statistics for 7 September ($n=2$ per arm).}
\label{tab:stats}
\end{table}
...
\begin{tabular}{lr}
\toprule
Dataset / execution statistic & Value \\
\midrule
Table-A records & 2,616 \\
Table-B records & 64,263 \\
Gold matching pairs & 5,347 \\
Candidate pairs per run & 13,080 \\
Gold matches retained by blocking & 2,540 \\
Gold matches omitted by blocking & 2,807 \\
Blocking recall & 47.50\% \\
Completed runs (4 September / 7 September) & 2 / 4 \\
Terminal matcher errors across completed runs & 0 \\
New checkpoint records (7 September) & 52,320 \\
Empty responses recovered by retry (7 September) & 1 \\
\bottomrule
\end{tabular}
\caption{Dataset coverage and execution statistics. Candidate sets are identical
across all six completed runs.}
\end{table}
...
\toprule
Draw & Arm & TP & FP & Candidate FN & E2E FN \\
\midrule
2 & Adaptive & 2,417 & 344 & 123 & 2,930 \\
2 & Full & 2,471 & 1,012 & 69 & 2,876 \\
3 & Adaptive & 2,428 & 366 & 112 & 2,919 \\
3 & Full & 2,439 & 1,130 & 101 & 2,908 \\
\bottomrule
\end{tabular}
